...
public class GetContactActivity extends WalletActivityBase {

    private GetContactViewModel model_;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model_ = ViewModelProviders.of(this).get(GetContactViewModel.class);
        setModel(model_);
